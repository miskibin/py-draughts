                ...
                if all_p & t_bit:
                    ...
                    if enemy & t_bit:
                        ...
                        for land in ray[i + 1 :]:
                            ...
                            for m in (
                                [self._combine_capture(base, s) for s in sub] if sub else [base]
                            ):
                                if m._value > max_val:
                ...
                if all_p & t_bit:
                    ...
                    if enemy & t_bit:
                        ...
                        for land in ray[i + 1 :]:
                            ...
                            forbidden.add(t)
                            self._king_captures(
                                land, enemy, captured, forbidden, sub_ortho, is_king
                            )
                            captured.discard(t)
                            forbidden.discard(t)
                            self.white_men, self.white_kings, self.black_men, self.black_kings = (
                            ...
                            for m in (
                                [self._combine_capture(base, s) for s in sub_ortho]
                                if sub_ortho
                                else [base]
                            ):
                                if m._value > max_val:
